...
public class Medium_2121_Intervals_Between_Identical_Elements {
    public static long[] getDistance(int[] nums) {
        int n = nums.length;
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(getDistance(new int[]{1,3,1,1,2})));
        System.out.println(Arrays.toString(getDistance(new int[]{0,5,3})));
    }
}
